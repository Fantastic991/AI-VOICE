...
export default async function handler(req, res) {
  try {
    ...
    const response = await openai.chat.completions.create({
      model: "gpt-4o-mini",
      modalities: ["text", "audio"], // ✅ ต้องเพิ่ม เพื่อรองรับเสียง
      messages: [
        {
          role: "system",
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: `Please rate how closely this audio matches the sentence: "${reference}". Give a score (0–100) and a short feedback.`,
            },
            {
              type: "input_audio",
